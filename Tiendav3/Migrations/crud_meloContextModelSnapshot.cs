...
{
    [DbContext(typeof(crud_meloContext))]
    partial class crud_meloContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tiendav3.Models.Cliente", b =>
                {
            ...
            modelBuilder.Entity("Tiendav3.Models.Factura", b =>
                {
            ...
            modelBuilder.Entity("Tiendav3.Models.Producto", b =>
                {
            ...
            modelBuilder.Entity("Tiendav3.Models.Factura", b =>
                {
                    b.HasOne("Tiendav3.Models.Cliente", "ClienteCedulaNavigation")
                        .WithMany("Facturas")
                        .HasForeignKey("ClienteCedula")
                        .HasConstraintName("FK__Facturas__Client__3B75D760");

                    b.HasOne("Tiendav3.Models.Producto", "ProductoCodigoNavigation")
                        .WithMany("Facturas")
                    ...
                    b.Navigation("ProductoCodigoNavigation");
                });
